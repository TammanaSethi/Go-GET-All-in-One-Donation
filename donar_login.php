...
<html>
    ...
    <body id="body1">
        ...
        <div class="row justify-content-center ">
            ...
            <?php
if(isset($_POST['btndonarlogin']))
{
    $email=mysqli_real_escape_string($con,$_POST['email']);
    $password=mysqli_real_escape_string($con,$_POST['password']);
    $q="select * from donar where email='$email' and password='$password'";
    $result=mysqli_query($con,$q);
    if(mysqli_num_rows($result)>0){
        $_SESSION['donaremail']=$email;
        
        echo "<script>window.location.href='donar_home.php'</script>";
    }
    else{
...
?>     
            ...
            <button class="btn55 " type="submit" name="btndonarlogin">Log In</button>
            <br/><br/>
        
        <p>Didn't have Account?<a href="donar.php">Register Now.</a></p>
        <br/>
        <br/>
        </form>
