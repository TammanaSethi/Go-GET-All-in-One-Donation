...
<html>
    ...
    <body id="body2">
        <div class="container-fluid">
            ...
            {
                $st=$_POST['searchtxt'];
                $query="select * from donar_add_donation where status='approval' and itemname like '%$st%'";
            }
            else{
$query="select * from donar_add_donation where status='approval'";
            }
...
<div class="col-lg-6 bg-light item6 mb-5 ">
                    ...
                    <br/>
                    <br/>
                    <a href="user_search_requests.php?id=<?php echo $row['id']?>">  <button type="submit" id="btntype">Request</button></a>
                   
                  
                    <a href="user_feedback.php?id=<?php echo $row['id']?>">  <button type="submit" id="btntype">Feedback</button></a>
