    ...
    <body id="body2">
        <div class="container-fluid">
            ...
            <div class="container">
                ...
                <?php
$query="select u.*,d.itemname, d.description, d.quantity from user_search_requests as u join donar_add_donation as d on u.donation_id=d.id where u.email='".$_SESSION['useremail']."'";
