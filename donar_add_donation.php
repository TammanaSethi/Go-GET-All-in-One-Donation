...
if(isset($_POST['btnadddonation']))
{
  ...
  $query="insert into donar_add_donation(itemname,description,quantity,landmark,city,address,pincode,mobile,curdate,picture, donar)  values('$itemname','$description','$quantity','$landmark','$city','$address','$pincode','$mobile',now(),'$pic','".$_SESSION['donaremail']."')";
